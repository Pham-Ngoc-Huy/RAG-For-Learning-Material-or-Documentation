...
const I18N = {
  en: {
    tagline: "AI assistant for VGU learning materials · a special gift for my lovely girlfriend 💗",
    navChat: "Chat",
  ...
  vi: {
    tagline: "Trợ lý hỏi-đáp tài liệu học tập cho sinh viên VGU · a special gift for my lovely girlfriend 💗",
    navChat: "Trò chuyện",
    navKb: "Kho tài liệu",
